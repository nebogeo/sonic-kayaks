...
sleep 5
# test the speaker
aplay -D bluetooth ~/lunaacid.wav
# start the jack server now
jackd -dalsa -dbluetooth -p2048 -r44100 > /home/pi/audio/audiotest/logs/jackd.log 2>&1   &
sleep 3
...
# start pd
pd -nogui -jack -path /home/pi/pd-iemnet:/home/pi/osc /home/pi/audio/audiotest/pd/select.pd > /home/pi/audio/audiotest/logs/puredate.log 2>&1  &    
